 ...
 *
 */
if ( ! class_exists( 'SOALI_OPTIONS_Field_sortable' ) ) {
  class SOALI_OPTIONS_Field_sortable extends SOALI_OPTIONS_Fields {
    ...
    public function render() {
      ...
      echo '<div class="soali_options-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="soali_options-sortable-item">';

          echo '<div class="soali_options-sortable-content">';
          ...
          SOALI_OPTIONS::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="soali_options-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
