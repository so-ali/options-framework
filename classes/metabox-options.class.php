 ...
 *
 */
if ( ! class_exists( 'SOALI_OPTIONS_Metabox' ) ) {
  class SOALI_OPTIONS_Metabox extends SOALI_OPTIONS_Abstract{
    ...
    public function add_meta_box_content( $post, $callback ) {
      ...
      echo '<div class="soali_options soali_options-metabox'. esc_attr( $theme ) .'">';
