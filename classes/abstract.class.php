 ...
 *
 */
if ( ! class_exists( 'SOALI_OPTIONS_Abstract' ) ) {
#[AllowDynamicProperties]
abstract class SOALI_OPTIONS_Abstract {
  ...
  public function __construct() {
    ...
    if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
      ...
      SOALI_OPTIONS::$css = apply_filters( "soali_options_{$this->unique}_output_css", SOALI_OPTIONS::$css, $this );
    }
  ...
  public function recursive_output_css( $fields = array(), $combine_field = array() ) {
    ...
    if ( ! empty( $fields ) ) {
      ...
      foreach ( $fields as $field ) {
        ...
        $field_class  = 'SOALI_OPTIONS_Field_' . $field_type;
          ...
          if ( class_exists( $field_class ) ) {
            ...
            if ( method_exists( $field_class, 'output' ) || method_exists( $field_class, 'enqueue_google_fonts' ) ) {
              ...
              if ( $field_output && $this->args['output_css'] ) {
                SOALI_OPTIONS::$css .= $instance->output();
              }
