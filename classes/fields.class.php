 ...
 *
 */
if ( ! class_exists( 'SOALI_OPTIONS_Fields' ) ) {
  abstract class SOALI_OPTIONS_Fields extends SOALI_OPTIONS_Abstract {
    ...
    public function field_before() {
      return ( ! empty( $this->field['before'] ) ) ? '<div class="soali_options-before-text">'. $this->field['before'] .'</div>' : '';
    }

    public function field_after() {

      $output  = ( ! empty( $this->field['after'] ) ) ? '<div class="soali_options-after-text">'. $this->field['after'] .'</div>' : '';
      $output .= ( ! empty( $this->field['desc'] ) ) ? '<div class="clear"></div><div class="soali_options-desc-text">'. $this->field['desc'] .'</div>' : '';
      $output .= ( ! empty( $this->field['help'] ) ) ? '<div class="soali_options-help"><span class="soali_options-help-text">'. $this->field['help'] .'</span><i class="fas fa-question-circle"></i></div>' : '';
      $output .= ( ! empty( $this->field['_error'] ) ) ? '<div class="soali_options-error-text">'. $this->field['_error'] .'</div>' : '';
