 ...
 *
 */
if ( ! class_exists( 'SOALI_OPTIONS_Field_link_color' ) ) {
  class SOALI_OPTIONS_Field_link_color extends SOALI_OPTIONS_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'soali_options' ),
        'hover'    => esc_html__( 'Hover', 'soali_options' ),
        'active'   => esc_html__( 'Active', 'soali_options' ),
        'visited'  => esc_html__( 'Visited', 'soali_options' ),
        'focus'    => esc_html__( 'Focus', 'soali_options' )
      );
      ...
      foreach ( $color_props as $color_prop_key => $color_prop_value ) {
        ...
        if ( ! empty( $args[$color_prop_key] ) ) {
          ...
          echo '<div class="soali_options--left soali_options-field-color">';
          echo '<div class="soali_options--title">'. esc_attr( $color_prop_value ) .'</div>';
          echo '<input type="text" name="'. esc_attr( $this->field_name( '['. $color_prop_key .']' ) ) .'" value="'. esc_attr( $value[$color_prop_key] ) .'" class="soali_options-color"'. $default_attr . $this->field_attributes() .'/>';
          echo '</div>';
